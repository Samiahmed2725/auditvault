...
export default function Dashboard() {
    ...
    const handleCreateClient = async (e) => {
        ...
        try {
            ...
            // Save what we just created to show the user
            setCreatedClient({ ...newClient });
            // Don't close modal here, let the user see the success state
            setNewClient({ name: '', email: '', password: '' });
            fetchClients(); // Refresh list
        } catch (error) {
            setCreateError('Failed to create client. Email might be taken.');
        }
    };
                        ...
                        {createdClient ? (
                            <div className="space-y-4">
                                <div className="rounded bg-green-50 p-4 border border-green-200">
                                    ...
                                    <p className="text-sm text-green-700 mb-4">Please share these credentials securely with your client:</p>
                                    ...
                                    <div className="bg-white p-3 rounded border font-mono text-sm space-y-2">
                                        ...
                                        <div><span className="text-gray-500">Password:</span> {createdClient.password}</div>
                                    </div>
                                </div>
                            ...
                            <form onSubmit={handleCreateClient} className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input
                                        type="text" // Shown as text so Auditor knows what they are setting
                                        className="mt-1 block w-full rounded-md border border-gray-300 p-2"
